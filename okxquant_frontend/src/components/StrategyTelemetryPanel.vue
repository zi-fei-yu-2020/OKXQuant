...
const statusMap: Record<string,string> = { reviewed: '已审计', pending: '处理中', running: '运行中', WAIT: '等待', incomplete: '未完成', unavailable: '不可用', failed: '失败' }
const localize = (v: unknown) => statusMap[String(v || '')] || String(v || '')
